...
**Status:** Controlled implementation intake. This manual is pre-staged behind Manuals 02–04 and must remain draft until the upstream stack and all Manual 05 release gates are complete.
...
The manual will organize audit work into seven controlled stages:
...
Manual 05 will cross-check its practical chapter structure against the three public ISACA AAIA domains:
...
The manual will use original implementation guidance and public domain names only; it will not copy proprietary AAIA review-manual or exam content.
...
Audit conclusions must be traceable to evidence. The future controlled chapter master will require, at minimum:
...
- [x] Scalable implementation paths pre-staged.
...
- [ ] Merge only through the reviewed stacked PR sequence.
