...
BASE = ROOT / '06-cloud-and-technology-risk/OT_ICS_Security_Controlled_Implementation/controlled'
OUT = ROOT / 'qa/manual21-publication-candidate'
OUT.mkdir(parents=True, exist_ok=True)

sources = {
    'en': BASE / 'en/MANUAL_21_CONTROLLED_EN.md',
    'es-419': BASE / 'es-419/MANUAL_21_CONTROLLED_ES_419.md',
    'pt-BR': BASE / 'pt-BR/MANUAL_21_CONTROLLED_PT_BR.md',
}

names = {
    'en': 'Manual_21_OT_ICS_Security_Controlled_EN',
    'es-419': 'Manual_21_OT_ICS_Security_Controlled_ES-419',
    'pt-BR': 'Manual_21_OT_ICS_Security_Controlled_PT-BR',
}
...
manifest = {'manual': 21, 'source_commit': os.environ.get('GITHUB_SHA', ''), 'artifacts': []}
...
(OUT / 'MANUAL_21_CANDIDATE_MANIFEST.json').write_text(json.dumps(manifest, indent=2), encoding='utf-8')
