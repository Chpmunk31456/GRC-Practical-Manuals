...
BASE = ROOT / '04-regulatory-compliance/NIS2_Controlled_Implementation/controlled'
OUT = ROOT / 'qa/manual24-publication-candidate'
OUT.mkdir(parents=True, exist_ok=True)

sources = {
    'en': BASE / 'en/MANUAL_24_CONTROLLED_EN.md',
    'es-419': BASE / 'es-419/MANUAL_24_CONTROLLED_ES-419.md',
    'pt-BR': BASE / 'pt-BR/MANUAL_24_CONTROLLED_PT-BR.md',
}

names = {
    'en': 'Manual_24_NIS2_Controlled_EN',
    'es-419': 'Manual_24_NIS2_Controlled_ES-419',
    'pt-BR': 'Manual_24_NIS2_Controlled_PT-BR',
}
...
manifest = {'manual': 24, 'source_commit': os.environ.get('GITHUB_SHA', ''), 'artifacts': []}
...
(OUT / 'MANUAL_24_CANDIDATE_MANIFEST.json').write_text(json.dumps(manifest, indent=2), encoding='utf-8')
