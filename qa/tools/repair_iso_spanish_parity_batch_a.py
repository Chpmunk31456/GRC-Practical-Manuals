...
REPLACEMENTS = [
    ...
    (
        ...
        "section 4 control-selection sentence",
    ),
    (
        ...
        "section 4 Annex A comparison sentence",
    ),
    (
        ...
        "section 4 applicability sentence",
    ),
    (
        ...
        "section 4 implementation-status sentence",
    ),
    (
        ...
        "section 4 documented-information sentence",
    ),
]
