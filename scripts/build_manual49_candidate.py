#!/usr/bin/env python3
"""Build the exact Manual 49 trilingual DOCX/PDF publication candidate."""
...
BASE = ROOT / "10-ai-governance/Manual_49_NIST_AI_RMF_GenAI"
OUT = ROOT / "qa/manual49-publication-candidate"
...
LOCALE_SOURCES = {
    "es-419": BASE / "controlled/es-419/MANUAL_49_CONTROLLED_ES-419.md",
    "pt-BR": BASE / "controlled/pt-BR/MANUAL_49_CONTROLLED_PT-BR.md",
}
NAMES = {
    "en": "Manual_49_NIST_AI_RMF_GenAI_EN",
    "es-419": "Manual_49_NIST_AI_RMF_GenAI_ES-419",
    "pt-BR": "Manual_49_NIST_AI_RMF_GenAI_PT-BR",
}
...
manifest = {
    "manual": 49,
    "title": "NIST AI RMF 1.0 + NIST AI 600-1 GenAI",
...
(OUT / "MANUAL_49_CANDIDATE_MANIFEST.json").write_text(
