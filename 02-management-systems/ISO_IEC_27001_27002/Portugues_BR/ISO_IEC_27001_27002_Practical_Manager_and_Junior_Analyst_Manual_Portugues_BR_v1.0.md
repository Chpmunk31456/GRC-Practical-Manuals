...
# 1. Fundamentos da ISO/IEC 27001 e da ISO/IEC 27002
...
|---|---|---|---|
| 5.1 | Manter políticas de segurança da informação aprovadas. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.5 | Manter o contato apropriado com as autoridades. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 5.6 | Participe de grupos de segurança relevantes e fóruns profissionais. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.9 | Informações de inventário e ativos associados. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.14 | Proteger as transferências de informação. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.20 | Inclua os requisitos de segurança nos acordos de fornecedores. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 5.21 | Gerencie o risco de segurança da cadeia de fornecimento de TIC. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 5.22 | Monitorar, rever e controlar as mudanças entre fornecedores e serviços. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.24 | Preparar e planejar a gestão de incidentes de segurança. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.26 | Responder a incidentes de segurança. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 5.37 | Manter procedimentos operacionais documentados. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 6.5 | Gerenciar os deveres de segurança após a cessação ou mudança de função. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| **Controle** | **Significado prático** | **Foco de verificação** | **Exemplo de evidência** |
|---|---|---|---|
| 7.1 | Defina e proteja perímetros de segurança física. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 7.4 | Monitorar instalações para acesso físico não autorizado. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 7.6 | Aplicar regras de trabalho para áreas seguras. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 7.7 | Use práticas claras e de tela clara. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 7.8 | Local e proteger o equipamento apropriadamente. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 7.12 | Proteger a energia e o cabeamento de dados. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 8.2 | Controle os direitos de acesso privilegiados. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 8.4 | Controle o acesso ao código fonte e ferramentas de desenvolvimento. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 8.5 | Use autenticação segura. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
...
| 8.21 | Serviços de rede seguros. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 8.22 | Segregate redes onde necessário. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 8.23 | Controle o acesso a sites externos. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 8.24 | Use e gerencie a criptografia apropriadamente. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
| 8.25 | Opere um ciclo de vida de desenvolvimento seguro. | Confirmar risco ou obrigação, design, proprietário, implementação, operação, exceções e medição. | Procedimento, configuração, registro, registro, ticket, revisão, teste ou observação. |
