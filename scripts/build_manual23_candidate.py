...
BASE = ROOT / '04-regulatory-compliance/DORA_Controlled_Implementation/controlled'
OUT = ROOT / 'qa/manual23-publication-candidate'
OUT.mkdir(parents=True, exist_ok=True)

sources = {
    'en': BASE / 'en/MANUAL_23_CONTROLLED_EN.md',
    'es-419': BASE / 'es-419/MANUAL_23_CONTROLLED_ES-419.md',
    'pt-BR': BASE / 'pt-BR/MANUAL_23_CONTROLLED_PT-BR.md',
}

names = {
    'en': 'Manual_23_DORA_Controlled_EN',
    'es-419': 'Manual_23_DORA_Controlled_ES-419',
    'pt-BR': 'Manual_23_DORA_Controlled_PT-BR',
}
...
manifest = {'manual': 23, 'source_commit': os.environ.get('GITHUB_SHA', ''), 'artifacts': []}
...
(OUT / 'MANUAL_23_CANDIDATE_MANIFEST.json').write_text(json.dumps(manifest, indent=2), encoding='utf-8')
