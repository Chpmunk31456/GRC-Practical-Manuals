#!/usr/bin/env python3
"""Build the exact Manual 48 trilingual DOCX/PDF publication candidate."""
...
BASE = ROOT / "10-ai-governance/Manual_48_Singapore_AI_Governance"
OUT = ROOT / "qa/manual48-publication-candidate"
...
LOCALE_SOURCES = {
    "es-419": BASE / "controlled/es-419/MANUAL_48_CONTROLLED_ES-419.md",
    "pt-BR": BASE / "controlled/pt-BR/MANUAL_48_CONTROLLED_PT-BR.md",
}
NAMES = {
    "en": "Manual_48_Singapore_AI_Governance_EN",
    "es-419": "Manual_48_Singapore_AI_Governance_ES-419",
    "pt-BR": "Manual_48_Singapore_AI_Governance_PT-BR",
}
...
manifest = {
    "manual": 48,
    "title": "Singapore AI Governance: MGF, GenAI, AI Verify & Agentic AI",
...
(OUT / "MANUAL_48_CANDIDATE_MANIFEST.json").write_text(
