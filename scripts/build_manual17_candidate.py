...
BASE=ROOT/'01-foundations/NIST_Privacy_Framework_Controlled_Implementation/controlled'
OUT=ROOT/'qa/manual17-publication-candidate'
...
names={
 'en':'Manual_17_NIST_Privacy_Framework_Controlled_EN',
 'es-419':'Manual_17_NIST_Privacy_Framework_Controlled_ES-419',
 'pt-BR':'Manual_17_NIST_Privacy_Framework_Controlled_PT-BR',
}
...
manifest={'manual':17,'source_commit':os.environ.get('GITHUB_SHA',''),'artifacts':[]}
...
(OUT/'MANUAL_17_CANDIDATE_MANIFEST.json').write_text(json.dumps(manifest,indent=2),encoding='utf-8')
